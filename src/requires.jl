function __init__()
  @require Plots = "91a5bcdd-55d7-5caf-9e0b-520d859cae80" begin
    ...
    * `linestyles::Vector{Symbol}`: a list of line styles.
    ...
    function performance_profile_plot(::PlotsBackend,
                                      x_plot,
                                      y_plot,
                                      max_ratio,
                                      xlabel,
    ...
    function data_profile_plot(::PlotsBackend,
                               T,
                               xs,
                               max_data,
                               xlabel,
  ...
  @require UnicodePlots = "b8865327-cd53-5732-bb35-84acbb429228" begin
    function performance_profile_plot(::UnicodePlotsBackend,
                                      x_plot,
                                      y_plot,
                                      max_ratio,
                                      xlabel,
    ...
    function data_profile_plot(::UnicodePlotsBackend,
                               T,
                               xs,
                               max_data,
                               xlabel,
